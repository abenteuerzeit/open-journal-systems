...
class PKPString {
	...
	/**
	 * @see https://ca.php.net/manual/en/function.strlen.php
	...
	/**
	 * @see https://ca.php.net/manual/en/function.strpos.php
	...
	/**
	 * @see https://ca.php.net/manual/en/function.strrpos.php
	...
	/**
	 * @see https://ca.php.net/manual/en/function.substr.php
	...
	/**
	 * @see https://ca.php.net/manual/en/function.strtolower.php
	 * @param $string string Input string
	...
	/**
	 * @see https://ca.php.net/manual/en/function.strtoupper.php
	 * @param $string string Input string
	...
	/**
	 * @see https://ca.php.net/manual/en/function.ucfirst.php
	 * @param $string string Input string
	...
	/**
	 * @see https://ca.php.net/manual/en/function.substr_count.php
	...
	/**
	 * @see https://ca.php.net/manual/en/function.encode_mime_header.php
	...
	/**
	 * @see https://ca.php.net/manual/en/function.regexp_quote.php
	...
	/**
	 * @see https://ca.php.net/manual/en/function.regexp_grep.php
	...
	/**
	 * @see https://ca.php.net/manual/en/function.regexp_match.php
	 * @param $pattern string Regular expression
	...
	/**
	 * @see https://ca.php.net/manual/en/function.regexp_match_get.php
	 * @param $pattern string Regular expression
	 * @param $subject string String to apply regular expression to
	...
	/**
	 * @see https://ca.php.net/manual/en/function.regexp_match_all.php
	 * @param $pattern string Regular expression
	 * @param $subject string String to apply regular expression to
	 * @param $matches array Reference to receive matches
	...
	/**
	 * @see https://ca.php.net/manual/en/function.regexp_replace.php
	 * @param $pattern string Regular expression
	...
	/**
	 * @see https://ca.php.net/manual/en/function.regexp_replace_callback.php
	 * @param $pattern string Regular expression
	...
	/**
	 * @see https://ca.php.net/manual/en/function.regexp_split.php
	 * @param $pattern string Regular expression
	 * @param $subject string String to apply regular expression to
	...
	/**
	 * @see https://ca.php.net/manual/en/function.mime_content_type.php
