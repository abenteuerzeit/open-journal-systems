...
- memcache: use include_once() to avoid issues with PHPUnit. See https://phplens.com/lens/lensforum/msgs.php?id=19489
...
- postgres7: fix system warning in MetaColumns() with schema. See https://phplens.com/lens/lensforum/msgs.php?id=19481
...
- adodb: GetRowAssoc will return null as required. See https://phplens.com/lens/lensforum/msgs.php?id=19289
- adodb: Fix GetRowAssoc bug introduced in 5.17, causing function to return data from previous fetch for NULL fields. See https://phplens.com/lens/lensforum/msgs.php?id=17539
...
- adodb: Fix LIMIT 1 clause in subquery gets stripped off. See https://phplens.com/lens/lensforum/msgs.php?id=17813
...
- ads: clear fields before fetching. See https://phplens.com/lens/lensforum/msgs.php?id=17539
- mssqlnative: fixed many FetchField compat issues. See https://phplens.com/lens/lensforum/msgs.php?id=18464. Also date format changed to remove timezone.
- mssqlnative: Numerous fixes and improvements by Mark Newnham
    ...
    - etc.
- mssqlnative: Fix Insert ID on prepared statement, thanks to Mike Parks. See https://phplens.com/lens/lensforum/msgs.php?id=19079
- mssql: timestamp format changed to `Y-m-d\TH:i:s` (ISO 8601) to make them independent from DATEFORMAT setting, as recommended on
  [Microsoft TechNet](https://technet.microsoft.com/en-us/library/ms180878%28v=sql.105%29.aspx#StringLiteralDateandTimeFormats).
- mysql/mysqli: Fix ability for MetaTables to filter by table name, broken since 5.15. See https://phplens.com/lens/lensforum/msgs.php?id=19359
- odbc: Fixed MetaTables and MetaPrimaryKeys definitions in odbc driver to match adoconnection class.
- odbc: clear fields before fetching. See https://phplens.com/lens/lensforum/msgs.php?id=17539
...
- pdo: Fixed concat recursion bug in 5.3. See https://phplens.com/lens/lensforum/msgs.php?id=19285
...
- postgres9: Fixed assoc problem. See https://phplens.com/lens/lensforum/msgs.php?id=19296
...
- datadict-postgres: Fixes bug in ALTER COL. See https://phplens.com/lens/lensforum/msgs.php?id=19202.
...
- adodb: When fetch mode is ADODB_FETCH_ASSOC, and we execute `$db->GetAssoc("select 'a','0'");` we get an error. Fixed. See https://phplens.com/lens/lensforum/msgs.php?id=19190
...
- mysqli: extra mysqli_next_result() in close() removed. See https://phplens.com/lens/lensforum/msgs.php?id=19100
- datadict-oci8: minor typo in create sequence trigger fixed. See https://phplens.com/lens/lensforum/msgs.php?id=18879.
...
- active-record: locked bug fixed. https://phplens.com/lens/lensforum/msgs.php?phplens_forummsg=new&id=19073
- mysql, mysqli and informix: added MetaProcedures. Metaprocedures allows to retrieve an array list of all procedures in database. https://phplens.com/lens/lensforum/msgs.php?id=18414
...
- mssqlnative: bugs in FetchField() fixed. See https://phplens.com/lens/lensforum/msgs.php?id=19024
...
- mssqlnative: return values for stored procedures where not returned! Fixed. See https://phplens.com/lens/lensforum/msgs.php?id=18919
...
- Fix bulk binding with oci8. https://phplens.com/lens/lensforum/msgs.php?id=18786
...
- memcache: compress option did not work. Fixed. See https://phplens.com/lens/lensforum/msgs.php?id=18899
...
- adodb active record. Fixed caching bug. See https://phplens.com/lens/lensforum/msgs.php?id=18288.
...
- Fixes RowLock() and MetaIndexes() inconsistencies. See https://phplens.com/lens/lensforum/msgs.php?id=18236
- Active record support for postgrseql boolean. See https://phplens.com/lens/lensforum/msgs.php?id=18246
- By default, Execute 2D array is disabled for security reasons. Set $conn->bulkBind = true to enable. See https://phplens.com/lens/lensforum/msgs.php?id=18270. Note this breaks backward compat.
- MSSQL: fixes for 5.2 compat. https://phplens.com/lens/lensforum/msgs.php?id=18325
...
- adodb-mysqli.inc.php: mysqli_multi_query is now turned off by default. To turn it on, use $conn->multiQuery = true; This is because of the risks of sql injection. See https://phplens.com/lens/lensforum/msgs.php?id=18144
...
- Fixed up MetaColumns and MetaPrimaryIndexes() for php 5.3 compat. Thx https://adodb.pastebin.com/m52082b16
...
- The oci8 driver did not handle LOBs properly when binding. Fixed. See https://phplens.com/lens/lensforum/msgs.php?id=17991.
...
- Added new property to postgres64 driver to support returning I if type is unique int called $db->uniqueIisR, defaulting to true. See https://phplens.com/lens/lensforum/msgs.php?id=17963
...
- New mssqlnative drivers for php. TQ Garrett Serack of M'soft. [Download](https://www.microsoft.com/downloads/details.aspx?FamilyId=61BF87E0-D031-466B-B09A-6597C21A2E2A&displaylang=en) mssqlnative extension. Note that this is still in beta.
...
- Added support for multiple recordsets in mysqli , thanks to Geisel Sierote geisel#4up.com.br. See https://phplens.com/lens/lensforum/msgs.php?id=15917
- Malcolm Cook added new Reload() function to Active Record. See https://phplens.com/lens/lensforum/msgs.php?id=17474
...
- In ADOdb5, active record implementation, we now support column names with spaces in them - we autoconvert the spaces to _ using __set(). Thx Daniel Cook. https://phplens.com/lens/lensforum/msgs.php?id=17200
- Removed $arg3 from mysqli SelectLimit. See https://phplens.com/lens/lensforum/msgs.php?id=16243. Thx Zsolt Szeberenyi.
