...
- Added support for multiple recordsets in mysqli Geisel Sierote <geisel#4up.com.br>. See https://phplens.com/lens/lensforum/msgs.php?id=15917
...
- Names longer than 30 chars in oci8 datadict will be changed to random name. Thx Eugenio. https://phplens.com/lens/lensforum/msgs.php?id=16182
- Added var $upperCase = 'ucase' to access and ado_access drivers. Thx Renato De Giovanni renato#cria.org.br
- Postgres64 driver, if preparing plan failed in _query, did not handle error properly. Fixed. See https://phplens.com/lens/lensforum/msgs.php?id=16131.
- Fixed GetActiveRecordsClass() reference bug. See https://phplens.com/lens/lensforum/msgs.php?id=16120
...
- Added connection property $db->null2null = 'null'. In autoexecute/getinsertsql/getupdatesql, this value will be converted to a null. Set this to a funny invalid value if you do not want null conversion. See https://phplens.com/lens/lensforum/msgs.php?id=15902.
...
- Patched postgres64 _connect to handle serverinfo(). see https://phplens.com/lens/lensforum/msgs.php?id=15887.
- Added pdo fix for null columns. See https://phplens.com/lens/lensforum/msgs.php?id=15889
...
- Fixed postgres connection bug: https://phplens.com/lens/lensforum/msgs.php?id=11057.
...
- Fix for GetAssoc() PHP5 compat. See https://phplens.com/lens/lensforum/msgs.php?id=15425
...
- Changed postgres7 MetaForeignKeys() see https://phplens.com/lens/lensforum/msgs.php?id=15531
...
- Error in ibase_blob_open() fixed. See https://phplens.com/lens/lensforum/msgs.php?id=14997
...
- Added register shutdown function session_write_close in adodb-session.inc.php for PHP 5 compat. See https://phplens.com/lens/lensforum/msgs.php?id=14200.

## 4.70 - 6 Jan 2006

- Many fixes from Danila Ulyanov to ibase, oci8, postgres, mssql, odbc_oracle, odbtp, etc drivers.
- Changed usage of binary hint in adodb-session.inc.php for mysql. See https://phplens.com/lens/lensforum/msgs.php?id=14160
- Fixed invalid variable reference problem in undomq(), adodb-perf.inc.php.
- Fixed https://phplens.com/lens/lensforum/msgs.php?id=14254 in adodb-perf.inc.php, `_DBParameter()` settings of fetchmode was wrong.
...
- Fixed postgresql bytea detection bug. See https://phplens.com/lens/lensforum/msgs.php?id=9849.
...
- New to adodb-time code. We allow you to define your own daylights savings function, adodb_daylight_sv for pre-1970 dates. If the function is defined (somewhere in an include), then you can correct for daylights savings. See https://phplens.com/phpeverywhere/node/view/16#daylightsavings for more info.
...
- Force autorollback for pgsql persistent connections - apparently pgsql did not autorollback properly before 4.3.4. See https://bugs.php.net/bug.php?id=25404
