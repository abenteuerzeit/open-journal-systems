...
*/
		...
		if (strncmp(PHP_OS,'WIN',3)==0) {
			...
			if (PHP_VERSION == '4.3.10') return false; # see https://bugs.php.net/bug.php?id=31737
	...
	*/
	...
	<a href=?do=stats><b>Performance Stats</b></a> &nbsp; <a href=?do=viewsql><b>View SQL</b></a>
	 ...
	 "</tr></table>";
		...
		global $ADODB_vers;
		echo "<p><div align=center><font size=1>$ADODB_vers Sponsored by <a href=https://phplens.com/>phpLens</a></font></div>";
	}
