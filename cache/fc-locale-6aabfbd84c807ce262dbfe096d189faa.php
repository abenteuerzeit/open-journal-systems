<?php return array (
  ...
  'user.profile.form.urlInvalid' => 'The specified URL is not valid. Please double-check the URL and try again. (Hint: Try adding https:// to the beginning of the URL.)',
