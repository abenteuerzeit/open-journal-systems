...
<ul>
	...
	<li>Operating system: Any OS that supports the above software, including <a href="https://www.linux.org/" target="_blank">Linux</a>, <a href="https://www.bsd.org/" target="_blank">BSD</a>, <a href="https://www.oracle.com/sun/" target="_blank">Solaris</a>, <a href="https://www.apple.com/" target="_blank">Mac OS X</a>, <a href="https://www.microsoft.com/">Windows</a></li>
</ul>
...
<p>OJS has currently only been tested on MySQL and PostgreSQL, although other database management systems supported by <a href="https://adodb.sourceforge.net/" target="_blank">ADOdb</a> may work (in full or partially). Compatibility reports and/or code patches for alternative DBMSs can be sent to the OJS team.</p>
',
...
<p>If you are running in <a href="https://www.php.net/features.safe-mode" target="_blank">PHP Safe Mode</a>, please ensure that the max_execution_time directive in your php.ini configuration file is set to a high limit. If this or any other time limit (e.g. Apache\'s "Timeout" directive) is reached and the upgrade process is interrupted, manual intervention will be required.</p>',
...
<ol>
	<li>Read the <a href="https://pkp.sfu.ca/blog" target="_new">PKP blog</a> and follow the <a href="https://pkp.sfu.ca/blog/feed" target="_new">RSS feed</a> for news and updates.</li>
...
<p>If you haven\'t already registered and wish to receive news and updates, <strong>please register at <a href="https://pkp.sfu.ca/ojs/register" target="_new">https://pkp.sfu.ca/ojs/register</a>.</strong> If you have questions or comments, please visit the <a href="https://forum.pkp.sfu.ca" target="_new">support forum</a>.</p>',
  ...
  'site.upgradeAvailable.manager' => 'There is a new version of OJS available! You are currently using OJS {$currentVersion}. The most recent version is OJS {$latestVersion}. Please contact your Site Administrator ({$siteAdminName}, <a href="mailto:{$siteAdminEmail}">{$siteAdminEmail}</a>) to notify them of this new release. More information can be found <a href="https://pkp.sfu.ca/ojs_download" target="_new">here</a>.',
