<?php return array (
  ...
  'manager.setup.lockssLicenseDescription' => 'A LOCKSS license will appear in About the Journal under Archiving: <a href="https://www.lockss.org/community/publishers-titles-gln/" target="_blank">LOCKSS License</a>',
  'manager.setup.lockssLicenseLabel' => 'LOCKSS License Description',
  'manager.setup.lockssRegister' => 'Identify 6-10 libraries that will register and cache the journal. For example, turn to institutions where editors or Board members work and/or institutions already participating in LOCKSS. See <a href="https://www.lockss.org/community/" target="_blank">the LOCKSS community</a>.',
  ...
  'manager.setup.navItemIsAbsolute' => 'URL is an absolute URL (e.g., "https://www.example.com") rather than a path relative to the site (e.g., "/manager/setup")',
