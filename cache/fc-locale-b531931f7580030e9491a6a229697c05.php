<?php return array (
  ...
  'manager.setup.dateTime.description' => 'Choose the preferred format for dates and times. A custom format can be entered using the special <a href=\'https://php.net/manual/en/function.strftime.php#refsect1-function.strftime-parameters\'>format characters</a>.',
  ...
  'manager.setup.metadata.type.description' => 'The nature or genre of the main content of the submission. The type is usually "Text", but may also be "Dataset", "Image" or any of the <a target="_blank" href="https://dublincore.org/documents/dcmi-type-vocabulary/#section-7-dcmi-type-vocabulary">Dublin Core types</a>.',
